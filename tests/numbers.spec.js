...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it ("Verifica se a função `numbers` retorna `false` quando recebe pelo menos 1 elemento que não seja do typeOf number", () => {
        // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
    expect(numbers([1, 2, '3', 4, 5])).toEqual(false);
  });
  it ("Verifica se a função `numbers` retorna `false` quando recebe pelo menos 1 elemento que não seja número", () => {
